...
func (GetMessagesRequest_Order) EnumDescriptor() ([]byte, []int) {
	return file_spec_proto_rawDescGZIP(), []int{159, 0}
}
...
var file_spec_proto_rawDesc = []byte{
	...
	0x65, 0x54, 0x79, 0x70, 0x65, 0x49, 0x64, 0x22, 0x58, 0x0a, 0x20, 0x41, 0x50, 0x49, 0x47, 0x65,
	...
	0x22, 0x00, 0x32, 0xcb, 0x0c, 0x0a, 0x05, 0x49, 0x74, 0x65, 0x6d, 0x73, 0x12, 0x53, 0x0a, 0x10,
	...
	0x73, 0x4c, 0x69, 0x73, 0x74, 0x22, 0x00, 0x12, 0x3b, 0x0a, 0x04, 0x4c, 0x69, 0x73, 0x74, 0x12,
...
var (
	...
	file_spec_proto_msgTypes  = make([]protoimpl.MessageInfo, 167)
	file_spec_proto_goTypes   = []interface{}{
		...
		(*APIGetItemParentLanguagesRequest)(nil),  // 162: goautowp.APIGetItemParentLanguagesRequest
		(*ItemParentLanguages)(nil),               // 163: goautowp.ItemParentLanguages
		(*ItemParentLanguage)(nil),                // 164: goautowp.ItemParentLanguage
		(*AddCommentRequest)(nil),                 // 165: goautowp.AddCommentRequest
		(*GetMessagePageRequest)(nil),             // 166: goautowp.GetMessagePageRequest
		(*CommentMessageFields)(nil),              // 167: goautowp.CommentMessageFields
		(*GetMessageRequest)(nil),                 // 168: goautowp.GetMessageRequest
		(*GetMessagesRequest)(nil),                // 169: goautowp.GetMessagesRequest
		(*APICommentsMessagePage)(nil),            // 170: goautowp.APICommentsMessagePage
		(*APICommentsMessages)(nil),               // 171: goautowp.APICommentsMessages
		(*APICommentsMessage)(nil),                // 172: goautowp.APICommentsMessage
		(*AddCommentResponse)(nil),                // 173: goautowp.AddCommentResponse
		(*APIGetTextRequest)(nil),                 // 174: goautowp.APIGetTextRequest
		(*TextRevision)(nil),                      // 175: goautowp.TextRevision
		(*APIGetTextResponse)(nil),                // 176: goautowp.APIGetTextResponse
		(*errdetails.RetryInfo)(nil),              // 177: google.rpc.RetryInfo
		(*errdetails.DebugInfo)(nil),              // 178: google.rpc.DebugInfo
		(*errdetails.QuotaFailure)(nil),           // 179: google.rpc.QuotaFailure
		(*errdetails.PreconditionFailure)(nil),    // 180: google.rpc.PreconditionFailure
		(*errdetails.BadRequest)(nil),             // 181: google.rpc.BadRequest
		(*errdetails.RequestInfo)(nil),            // 182: google.rpc.RequestInfo
		(*errdetails.Help)(nil),                   // 183: google.rpc.Help
		(*errdetails.LocalizedMessage)(nil),       // 184: google.rpc.LocalizedMessage
...
var file_spec_proto_depIdxs = []int32{
	177, // 0: goautowp.ErrorDetails.retryInfo:type_name -> google.rpc.RetryInfo
	178, // 1: goautowp.ErrorDetails.debugInfo:type_name -> google.rpc.DebugInfo
	179, // 2: goautowp.ErrorDetails.quotaFailure:type_name -> google.rpc.QuotaFailure
	180, // 3: goautowp.ErrorDetails.preconditionFailure:type_name -> google.rpc.PreconditionFailure
	181, // 4: goautowp.ErrorDetails.badRequest:type_name -> google.rpc.BadRequest
	182, // 5: goautowp.ErrorDetails.requestInfo:type_name -> google.rpc.RequestInfo
	183, // 6: goautowp.ErrorDetails.help:type_name -> google.rpc.Help
	184, // 7: goautowp.ErrorDetails.localizedMessage:type_name -> google.rpc.LocalizedMessage
	...
	185, // 29: goautowp.APIUser.last_online:type_name -> google.protobuf.Timestamp
	...
	185, // 35: goautowp.APIBanItem.until:type_name -> google.protobuf.Timestamp
	...
	185, // 43: goautowp.APIForumsTopic.created_at:type_name -> google.protobuf.Timestamp
	...
	185, // 46: goautowp.APICommentMessage.created_at:type_name -> google.protobuf.Timestamp
	...
	185, // 74: goautowp.APIMessage.date:type_name -> google.protobuf.Timestamp
	...
	185, // 78: goautowp.VODDataDate.date:type_name -> google.protobuf.Timestamp
	...
	185, // 83: goautowp.Article.date:type_name -> google.protobuf.Timestamp
	...
	164, // 86: goautowp.ItemParentLanguages.items:type_name -> goautowp.ItemParentLanguage
	4,   // 87: goautowp.AddCommentRequest.type_id:type_name -> goautowp.CommentsType
	167, // 88: goautowp.GetMessageRequest.fields:type_name -> goautowp.CommentMessageFields
	167, // 89: goautowp.GetMessagesRequest.fields:type_name -> goautowp.CommentMessageFields
	4,   // 90: goautowp.GetMessagesRequest.type_id:type_name -> goautowp.CommentsType
	9,   // 91: goautowp.GetMessagesRequest.order:type_name -> goautowp.GetMessagesRequest.Order
	5,   // 92: goautowp.GetMessagesRequest.moderator_attention:type_name -> goautowp.ModeratorAttention
	4,   // 93: goautowp.APICommentsMessagePage.type_id:type_name -> goautowp.CommentsType
	172, // 94: goautowp.APICommentsMessages.items:type_name -> goautowp.APICommentsMessage
	140, // 95: goautowp.APICommentsMessages.paginator:type_name -> goautowp.Pages
	4,   // 96: goautowp.APICommentsMessage.type_id:type_name -> goautowp.CommentsType
	185, // 97: goautowp.APICommentsMessage.created_at:type_name -> google.protobuf.Timestamp
	5,   // 98: goautowp.APICommentsMessage.moderator_attention:type_name -> goautowp.ModeratorAttention
	172, // 99: goautowp.APICommentsMessage.replies:type_name -> goautowp.APICommentsMessage
	2,   // 100: goautowp.APICommentsMessage.picture_status:type_name -> goautowp.PictureStatus
	175, // 101: goautowp.APIGetTextResponse.current:type_name -> goautowp.TextRevision
	175, // 102: goautowp.APIGetTextResponse.prev:type_name -> goautowp.TextRevision
	175, // 103: goautowp.APIGetTextResponse.next:type_name -> goautowp.TextRevision
	40,  // 104: goautowp.Autowp.AclEnforce:input_type -> goautowp.AclEnforceRequest
	63,  // 105: goautowp.Autowp.CreateFeedback:input_type -> goautowp.APICreateFeedbackRequest
	186, // 106: goautowp.Autowp.GetBrandIcons:input_type -> google.protobuf.Empty
	44,  // 107: goautowp.Autowp.GetBrandVehicleTypes:input_type -> goautowp.GetBrandVehicleTypesRequest
	60,  // 108: goautowp.Autowp.GetIP:input_type -> goautowp.APIGetIPRequest
	186, // 109: goautowp.Autowp.GetPerspectives:input_type -> google.protobuf.Empty
	186, // 110: goautowp.Autowp.GetPerspectivePages:input_type -> google.protobuf.Empty
	186, // 111: goautowp.Autowp.GetReCaptchaConfig:input_type -> google.protobuf.Empty
	186, // 112: goautowp.Autowp.GetSpecs:input_type -> google.protobuf.Empty
	186, // 113: goautowp.Autowp.GetVehicleTypes:input_type -> google.protobuf.Empty
	186, // 114: goautowp.Forums.GetUserSummary:input_type -> google.protobuf.Empty
	80,  // 115: goautowp.Forums.CreateTopic:input_type -> goautowp.APICreateTopicRequest
	82,  // 116: goautowp.Forums.CloseTopic:input_type -> goautowp.APISetTopicStatusRequest
	82,  // 117: goautowp.Forums.OpenTopic:input_type -> goautowp.APISetTopicStatusRequest
	82,  // 118: goautowp.Forums.DeleteTopic:input_type -> goautowp.APISetTopicStatusRequest
	83,  // 119: goautowp.Forums.MoveTopic:input_type -> goautowp.APIMoveTopicRequest
	71,  // 120: goautowp.Forums.GetTheme:input_type -> goautowp.APIGetForumsThemeRequest
	74,  // 121: goautowp.Forums.GetThemes:input_type -> goautowp.APIGetForumsThemesRequest
	73,  // 122: goautowp.Forums.GetTopic:input_type -> goautowp.APIGetForumsTopicRequest
	71,  // 123: goautowp.Forums.GetLastTopic:input_type -> goautowp.APIGetForumsThemeRequest
	73,  // 124: goautowp.Forums.GetLastMessage:input_type -> goautowp.APIGetForumsTopicRequest
	72,  // 125: goautowp.Forums.GetTopics:input_type -> goautowp.APIGetForumsTopicsRequest
	148, // 126: goautowp.Articles.GetList:input_type -> goautowp.ArticlesRequest
	151, // 127: goautowp.Articles.GetItemByCatname:input_type -> goautowp.ArticleByCatnameRequest
	66,  // 128: goautowp.Traffic.AddToBlacklist:input_type -> goautowp.AddToTrafficBlacklistRequest
	67,  // 129: goautowp.Traffic.AddToWhitelist:input_type -> goautowp.AddToTrafficWhitelistRequest
	65,  // 130: goautowp.Traffic.DeleteFromBlacklist:input_type -> goautowp.DeleteFromTrafficBlacklistRequest
	64,  // 131: goautowp.Traffic.DeleteFromWhitelist:input_type -> goautowp.DeleteFromTrafficWhitelistRequest
	186, // 132: goautowp.Traffic.GetTop:input_type -> google.protobuf.Empty
	186, // 133: goautowp.Traffic.GetWhitelist:input_type -> google.protobuf.Empty
	47,  // 134: goautowp.Contacts.CreateContact:input_type -> goautowp.CreateContactRequest
	48,  // 135: goautowp.Contacts.DeleteContact:input_type -> goautowp.DeleteContactRequest
	49,  // 136: goautowp.Contacts.GetContact:input_type -> goautowp.GetContactRequest
	54,  // 137: goautowp.Contacts.GetContacts:input_type -> goautowp.GetContactsRequest
	86,  // 138: goautowp.Users.DeleteUser:input_type -> goautowp.APIDeleteUserRequest
	88,  // 139: goautowp.Users.GetUser:input_type -> goautowp.APIGetUserRequest
	87,  // 140: goautowp.Users.Me:input_type -> goautowp.APIMeRequest
	144, // 141: goautowp.Users.GetUserPreferences:input_type -> goautowp.APIUserPreferencesRequest
	144, // 142: goautowp.Users.DisableUserCommentsNotifications:input_type -> goautowp.APIUserPreferencesRequest
	144, // 143: goautowp.Users.EnableUserCommentsNotifications:input_type -> goautowp.APIUserPreferencesRequest
	146, // 144: goautowp.Users.GetUsers:input_type -> goautowp.APIUsersRequest
	89,  // 145: goautowp.Items.GetTopBrandsList:input_type -> goautowp.GetTopBrandsListRequest
	92,  // 146: goautowp.Items.GetTopPersonsList:input_type -> goautowp.GetTopPersonsListRequest
	96,  // 147: goautowp.Items.GetTopFactoriesList:input_type -> goautowp.GetTopFactoriesListRequest
	95,  // 148: goautowp.Items.GetTopCategoriesList:input_type -> goautowp.GetTopCategoriesListRequest
	93,  // 149: goautowp.Items.GetTwinsBrandsList:input_type -> goautowp.GetTwinsBrandsListRequest
	94,  // 150: goautowp.Items.GetTopTwinsBrandsList:input_type -> goautowp.GetTopTwinsBrandsListRequest
	111, // 151: goautowp.Items.List:input_type -> goautowp.ListItemsRequest
	112, // 152: goautowp.Items.GetTree:input_type -> goautowp.GetTreeRequest
	186, // 153: goautowp.Items.GetContentLanguages:input_type -> google.protobuf.Empty
	153, // 154: goautowp.Items.GetItemLink:input_type -> goautowp.APIItemLinkRequest
	154, // 155: goautowp.Items.GetItemLinks:input_type -> goautowp.APIGetItemLinksRequest
	153, // 156: goautowp.Items.DeleteItemLink:input_type -> goautowp.APIItemLinkRequest
	156, // 157: goautowp.Items.CreateItemLink:input_type -> goautowp.APIItemLink
	156, // 158: goautowp.Items.UpdateItemLink:input_type -> goautowp.APIItemLink
	158, // 159: goautowp.Items.GetItemVehicleTypes:input_type -> goautowp.APIGetItemVehicleTypesRequest
	161, // 160: goautowp.Items.GetItemVehicleType:input_type -> goautowp.APIItemVehicleTypeRequest
	159, // 161: goautowp.Items.CreateItemVehicleType:input_type -> goautowp.APIItemVehicleType
	161, // 162: goautowp.Items.DeleteItemVehicleType:input_type -> goautowp.APIItemVehicleTypeRequest
	162, // 163: goautowp.Items.GetItemParentLanguages:input_type -> goautowp.APIGetItemParentLanguagesRequest
	118, // 164: goautowp.Comments.GetCommentVotes:input_type -> goautowp.GetCommentVotesRequest
	116, // 165: goautowp.Comments.Subscribe:input_type -> goautowp.CommentsSubscribeRequest
	117, // 166: goautowp.Comments.UnSubscribe:input_type -> goautowp.CommentsUnSubscribeRequest
	119, // 167: goautowp.Comments.View:input_type -> goautowp.CommentsViewRequest
	120, // 168: goautowp.Comments.SetDeleted:input_type -> goautowp.CommentsSetDeletedRequest
	121, // 169: goautowp.Comments.MoveComment:input_type -> goautowp.CommentsMoveCommentRequest
	122, // 170: goautowp.Comments.VoteComment:input_type -> goautowp.CommentsVoteCommentRequest
	165, // 171: goautowp.Comments.Add:input_type -> goautowp.AddCommentRequest
	166, // 172: goautowp.Comments.GetMessagePage:input_type -> goautowp.GetMessagePageRequest
	168, // 173: goautowp.Comments.GetMessage:input_type -> goautowp.GetMessageRequest
	169, // 174: goautowp.Comments.GetMessages:input_type -> goautowp.GetMessagesRequest
	124, // 175: goautowp.Map.GetPoints:input_type -> goautowp.MapGetPointsRequest
	128, // 176: goautowp.Pictures.View:input_type -> goautowp.PicturesViewRequest
	129, // 177: goautowp.Pictures.Vote:input_type -> goautowp.PicturesVoteRequest
	131, // 178: goautowp.Pictures.CreateModerVoteTemplate:input_type -> goautowp.ModerVoteTemplate
	133, // 179: goautowp.Pictures.DeleteModerVoteTemplate:input_type -> goautowp.DeleteModerVoteTemplateRequest
	186, // 180: goautowp.Pictures.GetModerVoteTemplates:input_type -> google.protobuf.Empty
	186, // 181: goautowp.Messaging.GetMessagesNewCount:input_type -> google.protobuf.Empty
	186, // 182: goautowp.Messaging.GetMessagesSummary:input_type -> google.protobuf.Empty
	134, // 183: goautowp.Messaging.DeleteMessage:input_type -> goautowp.MessagingDeleteMessage
	135, // 184: goautowp.Messaging.ClearFolder:input_type -> goautowp.MessagingClearFolder
	136, // 185: goautowp.Messaging.CreateMessage:input_type -> goautowp.MessagingCreateMessage
	138, // 186: goautowp.Messaging.GetMessages:input_type -> goautowp.MessagingGetMessagesRequest
	27,  // 187: goautowp.Statistics.GetPulse:input_type -> goautowp.PulseRequest
	186, // 188: goautowp.Statistics.GetAboutData:input_type -> google.protobuf.Empty
	186, // 189: goautowp.Donations.GetVODData:input_type -> google.protobuf.Empty
	174, // 190: goautowp.Text.GetText:input_type -> goautowp.APIGetTextRequest
	11,  // 191: goautowp.Attrs.GetAttribute:input_type -> goautowp.AttrAttributeID
	12,  // 192: goautowp.Attrs.GetAttributes:input_type -> goautowp.AttrAttributesRequest
	186, // 193: goautowp.Attrs.GetAttributeTypes:input_type -> google.protobuf.Empty
	15,  // 194: goautowp.Attrs.GetListOptions:input_type -> goautowp.AttrListOptionsRequest
	186, // 195: goautowp.Attrs.GetUnits:input_type -> google.protobuf.Empty
	18,  // 196: goautowp.Attrs.GetZoneAttributes:input_type -> goautowp.AttrZoneAttributesRequest
	186, // 197: goautowp.Attrs.GetZones:input_type -> google.protobuf.Empty
	41,  // 198: goautowp.Autowp.AclEnforce:output_type -> goautowp.AclEnforceResult
	186, // 199: goautowp.Autowp.CreateFeedback:output_type -> google.protobuf.Empty
	39,  // 200: goautowp.Autowp.GetBrandIcons:output_type -> goautowp.BrandIcons
	45,  // 201: goautowp.Autowp.GetBrandVehicleTypes:output_type -> goautowp.BrandVehicleTypeItems
	62,  // 202: goautowp.Autowp.GetIP:output_type -> goautowp.APIIP
	34,  // 203: goautowp.Autowp.GetPerspectives:output_type -> goautowp.PerspectivesItems
	37,  // 204: goautowp.Autowp.GetPerspectivePages:output_type -> goautowp.PerspectivePagesItems
	38,  // 205: goautowp.Autowp.GetReCaptchaConfig:output_type -> goautowp.ReCaptchaConfig
	32,  // 206: goautowp.Autowp.GetSpecs:output_type -> goautowp.SpecsItems
	43,  // 207: goautowp.Autowp.GetVehicleTypes:output_type -> goautowp.VehicleTypeItems
	70,  // 208: goautowp.Forums.GetUserSummary:output_type -> goautowp.APIForumsUserSummary
	81,  // 209: goautowp.Forums.CreateTopic:output_type -> goautowp.APICreateTopicResponse
	186, // 210: goautowp.Forums.CloseTopic:output_type -> google.protobuf.Empty
	186, // 211: goautowp.Forums.OpenTopic:output_type -> google.protobuf.Empty
	186, // 212: goautowp.Forums.DeleteTopic:output_type -> google.protobuf.Empty
	186, // 213: goautowp.Forums.MoveTopic:output_type -> google.protobuf.Empty
	75,  // 214: goautowp.Forums.GetTheme:output_type -> goautowp.APIForumsTheme
	76,  // 215: goautowp.Forums.GetThemes:output_type -> goautowp.APIForumsThemes
	77,  // 216: goautowp.Forums.GetTopic:output_type -> goautowp.APIForumsTopic
	77,  // 217: goautowp.Forums.GetLastTopic:output_type -> goautowp.APIForumsTopic
	79,  // 218: goautowp.Forums.GetLastMessage:output_type -> goautowp.APICommentMessage
	78,  // 219: goautowp.Forums.GetTopics:output_type -> goautowp.APIForumsTopics
	149, // 220: goautowp.Articles.GetList:output_type -> goautowp.ArticlesResponse
	150, // 221: goautowp.Articles.GetItemByCatname:output_type -> goautowp.Article
	186, // 222: goautowp.Traffic.AddToBlacklist:output_type -> google.protobuf.Empty
	186, // 223: goautowp.Traffic.AddToWhitelist:output_type -> google.protobuf.Empty
	186, // 224: goautowp.Traffic.DeleteFromBlacklist:output_type -> google.protobuf.Empty
	186, // 225: goautowp.Traffic.DeleteFromWhitelist:output_type -> google.protobuf.Empty
	59,  // 226: goautowp.Traffic.GetTop:output_type -> goautowp.APITrafficTopResponse
	69,  // 227: goautowp.Traffic.GetWhitelist:output_type -> goautowp.APITrafficWhitelistItems
	186, // 228: goautowp.Contacts.CreateContact:output_type -> google.protobuf.Empty
	186, // 229: goautowp.Contacts.DeleteContact:output_type -> google.protobuf.Empty
	52,  // 230: goautowp.Contacts.GetContact:output_type -> goautowp.Contact
	53,  // 231: goautowp.Contacts.GetContacts:output_type -> goautowp.ContactItems
	186, // 232: goautowp.Users.DeleteUser:output_type -> google.protobuf.Empty
	51,  // 233: goautowp.Users.GetUser:output_type -> goautowp.APIUser
	51,  // 234: goautowp.Users.Me:output_type -> goautowp.APIUser
	145, // 235: goautowp.Users.GetUserPreferences:output_type -> goautowp.APIUserPreferencesResponse
	186, // 236: goautowp.Users.DisableUserCommentsNotifications:output_type -> google.protobuf.Empty
	186, // 237: goautowp.Users.EnableUserCommentsNotifications:output_type -> google.protobuf.Empty
	147, // 238: goautowp.Users.GetUsers:output_type -> goautowp.APIUsersResponse
	90,  // 239: goautowp.Items.GetTopBrandsList:output_type -> goautowp.APITopBrandsList
	97,  // 240: goautowp.Items.GetTopPersonsList:output_type -> goautowp.APITopPersonsList
	104, // 241: goautowp.Items.GetTopFactoriesList:output_type -> goautowp.APITopFactoriesList
	102, // 242: goautowp.Items.GetTopCategoriesList:output_type -> goautowp.APITopCategoriesList
	100, // 243: goautowp.Items.GetTwinsBrandsList:output_type -> goautowp.APITwinsBrandsList
	101, // 244: goautowp.Items.GetTopTwinsBrandsList:output_type -> goautowp.APITopTwinsBrandsList
	115, // 245: goautowp.Items.List:output_type -> goautowp.APIItemList
	113, // 246: goautowp.Items.GetTree:output_type -> goautowp.APITreeItem
	152, // 247: goautowp.Items.GetContentLanguages:output_type -> goautowp.APIContentLanguages
	156, // 248: goautowp.Items.GetItemLink:output_type -> goautowp.APIItemLink
	155, // 249: goautowp.Items.GetItemLinks:output_type -> goautowp.APIItemLinksResponse
	186, // 250: goautowp.Items.DeleteItemLink:output_type -> google.protobuf.Empty
	157, // 251: goautowp.Items.CreateItemLink:output_type -> goautowp.APICreateItemLinkResponse
	186, // 252: goautowp.Items.UpdateItemLink:output_type -> google.protobuf.Empty
	160, // 253: goautowp.Items.GetItemVehicleTypes:output_type -> goautowp.APIGetItemVehicleTypesResponse
	159, // 254: goautowp.Items.GetItemVehicleType:output_type -> goautowp.APIItemVehicleType
	186, // 255: goautowp.Items.CreateItemVehicleType:output_type -> google.protobuf.Empty
	186, // 256: goautowp.Items.DeleteItemVehicleType:output_type -> google.protobuf.Empty
	163, // 257: goautowp.Items.GetItemParentLanguages:output_type -> goautowp.ItemParentLanguages
	55,  // 258: goautowp.Comments.GetCommentVotes:output_type -> goautowp.CommentVoteItems
	186, // 259: goautowp.Comments.Subscribe:output_type -> google.protobuf.Empty
	186, // 260: goautowp.Comments.UnSubscribe:output_type -> google.protobuf.Empty
	186, // 261: goautowp.Comments.View:output_type -> google.protobuf.Empty
	186, // 262: goautowp.Comments.SetDeleted:output_type -> google.protobuf.Empty
	186, // 263: goautowp.Comments.MoveComment:output_type -> google.protobuf.Empty
	123, // 264: goautowp.Comments.VoteComment:output_type -> goautowp.CommentsVoteCommentResponse
	173, // 265: goautowp.Comments.Add:output_type -> goautowp.AddCommentResponse
	170, // 266: goautowp.Comments.GetMessagePage:output_type -> goautowp.APICommentsMessagePage
	172, // 267: goautowp.Comments.GetMessage:output_type -> goautowp.APICommentsMessage
	171, // 268: goautowp.Comments.GetMessages:output_type -> goautowp.APICommentsMessages
	126, // 269: goautowp.Map.GetPoints:output_type -> goautowp.MapPoints
	186, // 270: goautowp.Pictures.View:output_type -> google.protobuf.Empty
	130, // 271: goautowp.Pictures.Vote:output_type -> goautowp.PicturesVoteSummary
	131, // 272: goautowp.Pictures.CreateModerVoteTemplate:output_type -> goautowp.ModerVoteTemplate
	186, // 273: goautowp.Pictures.DeleteModerVoteTemplate:output_type -> google.protobuf.Empty
	132, // 274: goautowp.Pictures.GetModerVoteTemplates:output_type -> goautowp.ModerVoteTemplates
	84,  // 275: goautowp.Messaging.GetMessagesNewCount:output_type -> goautowp.APIMessageNewCount
	85,  // 276: goautowp.Messaging.GetMessagesSummary:output_type -> goautowp.APIMessageSummary
	186, // 277: goautowp.Messaging.DeleteMessage:output_type -> google.protobuf.Empty
	186, // 278: goautowp.Messaging.ClearFolder:output_type -> google.protobuf.Empty
	186, // 279: goautowp.Messaging.CreateMessage:output_type -> google.protobuf.Empty
	139, // 280: goautowp.Messaging.GetMessages:output_type -> goautowp.MessagingGetMessagesResponse
	30,  // 281: goautowp.Statistics.GetPulse:output_type -> goautowp.PulseResponse
	143, // 282: goautowp.Statistics.GetAboutData:output_type -> goautowp.AboutDataResponse
	141, // 283: goautowp.Donations.GetVODData:output_type -> goautowp.VODDataResponse
	176, // 284: goautowp.Text.GetText:output_type -> goautowp.APIGetTextResponse
	14,  // 285: goautowp.Attrs.GetAttribute:output_type -> goautowp.AttrAttribute
	13,  // 286: goautowp.Attrs.GetAttributes:output_type -> goautowp.AttrAttributesResponse
	21,  // 287: goautowp.Attrs.GetAttributeTypes:output_type -> goautowp.AttrAttributeTypesResponse
	16,  // 288: goautowp.Attrs.GetListOptions:output_type -> goautowp.AttrListOptionsResponse
	23,  // 289: goautowp.Attrs.GetUnits:output_type -> goautowp.AttrUnitsResponse
	19,  // 290: goautowp.Attrs.GetZoneAttributes:output_type -> goautowp.AttrZoneAttributesResponse
	25,  // 291: goautowp.Attrs.GetZones:output_type -> goautowp.AttrZonesResponse
