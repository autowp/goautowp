...
var file_spec_proto_rawDesc = []byte{
	...
	0x65, 0x6d, 0x54, 0x79, 0x70, 0x65, 0x22, 0x38, 0x0a, 0x1a, 0x47, 0x65, 0x74, 0x54, 0x6f, 0x70,
	...
	0x01, 0x28, 0x09, 0x52, 0x04, 0x6e, 0x61, 0x6d, 0x65, 0x22, 0x4e, 0x0a, 0x13, 0x41, 0x50, 0x49,
	...
	0x00, 0x32, 0xba, 0x06, 0x0a, 0x05, 0x55, 0x73, 0x65, 0x72, 0x73, 0x12, 0x46, 0x0a, 0x0a, 0x43,
	...
	0x79, 0x22, 0x00, 0x12, 0x46, 0x0a, 0x0a, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x55, 0x73, 0x65,
	...
	0x6f, 0x74, 0x6f, 0x62, 0x75, 0x66, 0x2e, 0x45, 0x6d, 0x70, 0x74, 0x79, 0x22, 0x00, 0x32, 0xcf,
	0x02, 0x0a, 0x05, 0x49, 0x74, 0x65, 0x6d, 0x73, 0x12, 0x53, 0x0a, 0x10, 0x47, 0x65, 0x74, 0x54,
...
var file_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 72)
var file_spec_proto_goTypes = []interface{}{
	...
	(*GetTopFactoriesListRequest)(nil),          // 64: goautowp.GetTopFactoriesListRequest
	(*APITopPersonsList)(nil),                   // 65: goautowp.APITopPersonsList
	(*APITopPersonsListItem)(nil),               // 66: goautowp.APITopPersonsListItem
	(*APITopFactoriesList)(nil),                 // 67: goautowp.APITopFactoriesList
	(*APITopFactoriesListItem)(nil),             // 68: goautowp.APITopFactoriesListItem
	(*ItemPicturesRequest)(nil),                 // 69: goautowp.ItemPicturesRequest
	(*PicturesRequest)(nil),                     // 70: goautowp.PicturesRequest
	(*PictureFields)(nil),                       // 71: goautowp.PictureFields
	(*PreviewPicturesFields)(nil),               // 72: goautowp.PreviewPicturesFields
	(*ItemFields)(nil),                          // 73: goautowp.ItemFields
	(*ListItemsRequest)(nil),                    // 74: goautowp.ListItemsRequest
	(*APIItem)(nil),                             // 75: goautowp.APIItem
	(*APIItemList)(nil),                         // 76: goautowp.APIItemList
	(*errdetails.RetryInfo)(nil),                // 77: google.rpc.RetryInfo
	(*errdetails.DebugInfo)(nil),                // 78: google.rpc.DebugInfo
	(*errdetails.QuotaFailure)(nil),             // 79: google.rpc.QuotaFailure
	(*errdetails.PreconditionFailure)(nil),      // 80: google.rpc.PreconditionFailure
	(*errdetails.BadRequest)(nil),               // 81: google.rpc.BadRequest
	(*errdetails.RequestInfo)(nil),              // 82: google.rpc.RequestInfo
	(*errdetails.Help)(nil),                     // 83: google.rpc.Help
	(*errdetails.LocalizedMessage)(nil),         // 84: google.rpc.LocalizedMessage
...
var file_spec_proto_depIdxs = []int32{
	77, // 0: goautowp.ErrorDetails.retryInfo:type_name -> google.rpc.RetryInfo
	78, // 1: goautowp.ErrorDetails.debugInfo:type_name -> google.rpc.DebugInfo
	79, // 2: goautowp.ErrorDetails.quotaFailure:type_name -> google.rpc.QuotaFailure
	80, // 3: goautowp.ErrorDetails.preconditionFailure:type_name -> google.rpc.PreconditionFailure
	81, // 4: goautowp.ErrorDetails.badRequest:type_name -> google.rpc.BadRequest
	82, // 5: goautowp.ErrorDetails.requestInfo:type_name -> google.rpc.RequestInfo
	83, // 6: goautowp.ErrorDetails.help:type_name -> google.rpc.Help
	84, // 7: goautowp.ErrorDetails.localizedMessage:type_name -> google.rpc.LocalizedMessage
	...
	85, // 18: goautowp.APIUser.last_online:type_name -> google.protobuf.Timestamp
	...
	85, // 24: goautowp.APIBanItem.until:type_name -> google.protobuf.Timestamp
	...
	66, // 33: goautowp.APITopPersonsList.items:type_name -> goautowp.APITopPersonsListItem
	68, // 34: goautowp.APITopFactoriesList.items:type_name -> goautowp.APITopFactoriesListItem
	3,  // 35: goautowp.ItemPicturesRequest.type_id:type_name -> goautowp.ItemPictureType
	70, // 36: goautowp.ItemPicturesRequest.pictures:type_name -> goautowp.PicturesRequest
	2,  // 37: goautowp.PicturesRequest.status:type_name -> goautowp.PictureStatus
	69, // 38: goautowp.PicturesRequest.item_picture:type_name -> goautowp.ItemPicturesRequest
	71, // 39: goautowp.PreviewPicturesFields.picture:type_name -> goautowp.PictureFields
	72, // 40: goautowp.ItemFields.preview_pictures:type_name -> goautowp.PreviewPicturesFields
	73, // 41: goautowp.ListItemsRequest.fields:type_name -> goautowp.ItemFields
	1,  // 42: goautowp.ListItemsRequest.type_id:type_name -> goautowp.ItemType
	69, // 43: goautowp.ListItemsRequest.descendant_pictures:type_name -> goautowp.ItemPicturesRequest
	69, // 44: goautowp.ListItemsRequest.preview_pictures:type_name -> goautowp.ItemPicturesRequest
	75, // 45: goautowp.APIItemList.items:type_name -> goautowp.APIItem
	15, // 46: goautowp.Autowp.AclEnforce:input_type -> goautowp.AclEnforceRequest
	42, // 47: goautowp.Autowp.AddToTrafficBlacklist:input_type -> goautowp.AddToTrafficBlacklistRequest
	43, // 48: goautowp.Autowp.AddToTrafficWhitelist:input_type -> goautowp.AddToTrafficWhitelistRequest
	39, // 49: goautowp.Autowp.CreateFeedback:input_type -> goautowp.APICreateFeedbackRequest
	41, // 50: goautowp.Autowp.DeleteFromTrafficBlacklist:input_type -> goautowp.DeleteFromTrafficBlacklistRequest
	40, // 51: goautowp.Autowp.DeleteFromTrafficWhitelist:input_type -> goautowp.DeleteFromTrafficWhitelistRequest
	86, // 52: goautowp.Autowp.GetBrandIcons:input_type -> google.protobuf.Empty
	19, // 53: goautowp.Autowp.GetBrandVehicleTypes:input_type -> goautowp.GetBrandVehicleTypesRequest
	30, // 54: goautowp.Autowp.GetCommentVotes:input_type -> goautowp.GetCommentVotesRequest
	86, // 55: goautowp.Autowp.GetForumsUserSummary:input_type -> google.protobuf.Empty
	36, // 56: goautowp.Autowp.GetIP:input_type -> goautowp.APIGetIPRequest
	86, // 57: goautowp.Autowp.GetMessagesNewCount:input_type -> google.protobuf.Empty
	86, // 58: goautowp.Autowp.GetMessagesSummary:input_type -> google.protobuf.Empty
	86, // 59: goautowp.Autowp.GetPerspectives:input_type -> google.protobuf.Empty
	86, // 60: goautowp.Autowp.GetPerspectivePages:input_type -> google.protobuf.Empty
	86, // 61: goautowp.Autowp.GetReCaptchaConfig:input_type -> google.protobuf.Empty
	86, // 62: goautowp.Autowp.GetSpecs:input_type -> google.protobuf.Empty
	86, // 63: goautowp.Autowp.GetTrafficTop:input_type -> google.protobuf.Empty
	86, // 64: goautowp.Autowp.GetTrafficWhitelist:input_type -> google.protobuf.Empty
	86, // 65: goautowp.Autowp.GetVehicleTypes:input_type -> google.protobuf.Empty
	22, // 66: goautowp.Contacts.CreateContact:input_type -> goautowp.CreateContactRequest
	23, // 67: goautowp.Contacts.DeleteContact:input_type -> goautowp.DeleteContactRequest
	24, // 68: goautowp.Contacts.GetContact:input_type -> goautowp.GetContactRequest
	29, // 69: goautowp.Contacts.GetContacts:input_type -> goautowp.GetContactsRequest
	49, // 70: goautowp.Users.CreateUser:input_type -> goautowp.APICreateUserRequest
	58, // 71: goautowp.Users.UpdateUser:input_type -> goautowp.APIUpdateUserRequest
	57, // 72: goautowp.Users.DeleteUser:input_type -> goautowp.APIDeleteUserRequest
	59, // 73: goautowp.Users.GetUser:input_type -> goautowp.APIGetUserRequest
	54, // 74: goautowp.Users.EmailChange:input_type -> goautowp.APIEmailChangeRequest
	55, // 75: goautowp.Users.EmailChangeConfirm:input_type -> goautowp.APIEmailChangeConfirmRequest
	50, // 76: goautowp.Users.PasswordRecovery:input_type -> goautowp.APIPasswordRecoveryRequest
	51, // 77: goautowp.Users.PasswordRecoveryCheckCode:input_type -> goautowp.APIPasswordRecoveryCheckCodeRequest
	52, // 78: goautowp.Users.PasswordRecoveryConfirm:input_type -> goautowp.APIPasswordRecoveryConfirmRequest
	56, // 79: goautowp.Users.SetPassword:input_type -> goautowp.APISetPasswordRequest
	60, // 80: goautowp.Items.GetTopBrandsList:input_type -> goautowp.GetTopBrandsListRequest
	63, // 81: goautowp.Items.GetTopPersonsList:input_type -> goautowp.GetTopPersonsListRequest
	64, // 82: goautowp.Items.GetTopFactoriesList:input_type -> goautowp.GetTopFactoriesListRequest
	74, // 83: goautowp.Items.List:input_type -> goautowp.ListItemsRequest
	16, // 84: goautowp.Autowp.AclEnforce:output_type -> goautowp.AclEnforceResult
	86, // 85: goautowp.Autowp.AddToTrafficBlacklist:output_type -> google.protobuf.Empty
	86, // 86: goautowp.Autowp.AddToTrafficWhitelist:output_type -> google.protobuf.Empty
	86, // 87: goautowp.Autowp.CreateFeedback:output_type -> google.protobuf.Empty
	86, // 88: goautowp.Autowp.DeleteFromTrafficBlacklist:output_type -> google.protobuf.Empty
	86, // 89: goautowp.Autowp.DeleteFromTrafficWhitelist:output_type -> google.protobuf.Empty
	14, // 90: goautowp.Autowp.GetBrandIcons:output_type -> goautowp.BrandIcons
	20, // 91: goautowp.Autowp.GetBrandVehicleTypes:output_type -> goautowp.BrandVehicleTypeItems
	31, // 92: goautowp.Autowp.GetCommentVotes:output_type -> goautowp.CommentVoteItems
	46, // 93: goautowp.Autowp.GetForumsUserSummary:output_type -> goautowp.APIForumsUserSummary
	38, // 94: goautowp.Autowp.GetIP:output_type -> goautowp.APIIP
	47, // 95: goautowp.Autowp.GetMessagesNewCount:output_type -> goautowp.APIMessageNewCount
	48, // 96: goautowp.Autowp.GetMessagesSummary:output_type -> goautowp.APIMessageSummary
	9,  // 97: goautowp.Autowp.GetPerspectives:output_type -> goautowp.PerspectivesItems
	12, // 98: goautowp.Autowp.GetPerspectivePages:output_type -> goautowp.PerspectivePagesItems
	13, // 99: goautowp.Autowp.GetReCaptchaConfig:output_type -> goautowp.ReCaptchaConfig
	7,  // 100: goautowp.Autowp.GetSpecs:output_type -> goautowp.SpecsItems
	35, // 101: goautowp.Autowp.GetTrafficTop:output_type -> goautowp.APITrafficTopResponse
	45, // 102: goautowp.Autowp.GetTrafficWhitelist:output_type -> goautowp.APITrafficWhitelistItems
	18, // 103: goautowp.Autowp.GetVehicleTypes:output_type -> goautowp.VehicleTypeItems
	86, // 104: goautowp.Contacts.CreateContact:output_type -> google.protobuf.Empty
	86, // 105: goautowp.Contacts.DeleteContact:output_type -> google.protobuf.Empty
	27, // 106: goautowp.Contacts.GetContact:output_type -> goautowp.Contact
	28, // 107: goautowp.Contacts.GetContacts:output_type -> goautowp.ContactItems
	86, // 108: goautowp.Users.CreateUser:output_type -> google.protobuf.Empty
	86, // 109: goautowp.Users.UpdateUser:output_type -> google.protobuf.Empty
	86, // 110: goautowp.Users.DeleteUser:output_type -> google.protobuf.Empty
	26, // 111: goautowp.Users.GetUser:output_type -> goautowp.APIUser
	86, // 112: goautowp.Users.EmailChange:output_type -> google.protobuf.Empty
	86, // 113: goautowp.Users.EmailChangeConfirm:output_type -> google.protobuf.Empty
	86, // 114: goautowp.Users.PasswordRecovery:output_type -> google.protobuf.Empty
	86, // 115: goautowp.Users.PasswordRecoveryCheckCode:output_type -> google.protobuf.Empty
	53, // 116: goautowp.Users.PasswordRecoveryConfirm:output_type -> goautowp.APIPasswordRecoveryConfirmResponse
	86, // 117: goautowp.Users.SetPassword:output_type -> google.protobuf.Empty
	61, // 118: goautowp.Items.GetTopBrandsList:output_type -> goautowp.APITopBrandsList
	65, // 119: goautowp.Items.GetTopPersonsList:output_type -> goautowp.APITopPersonsList
	67, // 120: goautowp.Items.GetTopFactoriesList:output_type -> goautowp.APITopFactoriesList
	76, // 121: goautowp.Items.List:output_type -> goautowp.APIItemList
