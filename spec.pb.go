...
var file_spec_proto_rawDesc = []byte{
	...
	0x43, 0x6f, 0x75, 0x6e, 0x74, 0x32, 0xe0, 0x04, 0x0a, 0x06, 0x41, 0x75, 0x74, 0x6f, 0x77, 0x70,
	...
	0x65, 0x52, 0x65, 0x73, 0x75, 0x6c, 0x74, 0x22, 0x00, 0x12, 0x3f, 0x0a, 0x0d, 0x47, 0x65, 0x74,
	...
	0x65, 0x54, 0x79, 0x70, 0x65, 0x49, 0x74, 0x65, 0x6d, 0x73, 0x22, 0x00, 0x12, 0x48, 0x0a, 0x0f,
	...
	0x65, 0x49, 0x74, 0x65, 0x6d, 0x73, 0x22, 0x00, 0x42, 0x1c, 0x5a, 0x1a, 0x67, 0x69, 0x74, 0x68,
...
var file_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 16)
var file_spec_proto_goTypes = []interface{}{
	...
	(*GetBrandVehicleTypesRequest)(nil), // 13: goautowp.GetBrandVehicleTypesRequest
	(*BrandVehicleTypeItems)(nil),       // 14: goautowp.BrandVehicleTypeItems
	(*BrandVehicleType)(nil),            // 15: goautowp.BrandVehicleType
...
var file_spec_proto_depIdxs = []int32{
	...
	15, // 8: goautowp.BrandVehicleTypeItems.items:type_name -> goautowp.BrandVehicleType
	9,  // 9: goautowp.Autowp.AclEnforce:input_type -> goautowp.AclEnforceRequest
	16, // 10: goautowp.Autowp.GetBrandIcons:input_type -> google.protobuf.Empty
	13, // 11: goautowp.Autowp.GetBrandVehicleTypes:input_type -> goautowp.GetBrandVehicleTypesRequest
	16, // 12: goautowp.Autowp.GetPerspectives:input_type -> google.protobuf.Empty
	16, // 13: goautowp.Autowp.GetPerspectivePages:input_type -> google.protobuf.Empty
	16, // 14: goautowp.Autowp.GetReCaptchaConfig:input_type -> google.protobuf.Empty
	16, // 15: goautowp.Autowp.GetSpecs:input_type -> google.protobuf.Empty
	16, // 16: goautowp.Autowp.GetVehicleTypes:input_type -> google.protobuf.Empty
	10, // 17: goautowp.Autowp.AclEnforce:output_type -> goautowp.AclEnforceResult
	8,  // 18: goautowp.Autowp.GetBrandIcons:output_type -> goautowp.BrandIcons
	14, // 19: goautowp.Autowp.GetBrandVehicleTypes:output_type -> goautowp.BrandVehicleTypeItems
	3,  // 20: goautowp.Autowp.GetPerspectives:output_type -> goautowp.PerspectivesItems
	6,  // 21: goautowp.Autowp.GetPerspectivePages:output_type -> goautowp.PerspectivePagesItems
	7,  // 22: goautowp.Autowp.GetReCaptchaConfig:output_type -> goautowp.ReCaptchaConfig
	1,  // 23: goautowp.Autowp.GetSpecs:output_type -> goautowp.SpecsItems
	12, // 24: goautowp.Autowp.GetVehicleTypes:output_type -> goautowp.VehicleTypeItems
