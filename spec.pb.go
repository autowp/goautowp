...
func (GetMessagesRequest_Order) EnumDescriptor() ([]byte, []int) {
	return file_spec_proto_rawDescGZIP(), []int{156, 0}
}
...
var file_spec_proto_rawDesc = []byte{
	...
	0x65, 0x54, 0x79, 0x70, 0x65, 0x49, 0x64, 0x22, 0xdf, 0x01, 0x0a, 0x11, 0x41, 0x64, 0x64, 0x43,
	...
	0x00, 0x32, 0xe4, 0x0b, 0x0a, 0x05, 0x49, 0x74, 0x65, 0x6d, 0x73, 0x12, 0x53, 0x0a, 0x10, 0x47,
...
var (
	...
	file_spec_proto_msgTypes  = make([]protoimpl.MessageInfo, 164)
	file_spec_proto_goTypes   = []interface{}{
		...
		(*AddCommentRequest)(nil),                 // 162: goautowp.AddCommentRequest
		(*GetMessagePageRequest)(nil),             // 163: goautowp.GetMessagePageRequest
		(*CommentMessageFields)(nil),              // 164: goautowp.CommentMessageFields
		(*GetMessageRequest)(nil),                 // 165: goautowp.GetMessageRequest
		(*GetMessagesRequest)(nil),                // 166: goautowp.GetMessagesRequest
		(*APICommentsMessagePage)(nil),            // 167: goautowp.APICommentsMessagePage
		(*APICommentsMessages)(nil),               // 168: goautowp.APICommentsMessages
		(*APICommentsMessage)(nil),                // 169: goautowp.APICommentsMessage
		(*AddCommentResponse)(nil),                // 170: goautowp.AddCommentResponse
		(*APIGetTextRequest)(nil),                 // 171: goautowp.APIGetTextRequest
		(*TextRevision)(nil),                      // 172: goautowp.TextRevision
		(*APIGetTextResponse)(nil),                // 173: goautowp.APIGetTextResponse
		(*errdetails.RetryInfo)(nil),              // 174: google.rpc.RetryInfo
		(*errdetails.DebugInfo)(nil),              // 175: google.rpc.DebugInfo
		(*errdetails.QuotaFailure)(nil),           // 176: google.rpc.QuotaFailure
		(*errdetails.PreconditionFailure)(nil),    // 177: google.rpc.PreconditionFailure
		(*errdetails.BadRequest)(nil),             // 178: google.rpc.BadRequest
		(*errdetails.RequestInfo)(nil),            // 179: google.rpc.RequestInfo
		(*errdetails.Help)(nil),                   // 180: google.rpc.Help
		(*errdetails.LocalizedMessage)(nil),       // 181: google.rpc.LocalizedMessage
...
var file_spec_proto_depIdxs = []int32{
	174, // 0: goautowp.ErrorDetails.retryInfo:type_name -> google.rpc.RetryInfo
	175, // 1: goautowp.ErrorDetails.debugInfo:type_name -> google.rpc.DebugInfo
	176, // 2: goautowp.ErrorDetails.quotaFailure:type_name -> google.rpc.QuotaFailure
	177, // 3: goautowp.ErrorDetails.preconditionFailure:type_name -> google.rpc.PreconditionFailure
	178, // 4: goautowp.ErrorDetails.badRequest:type_name -> google.rpc.BadRequest
	179, // 5: goautowp.ErrorDetails.requestInfo:type_name -> google.rpc.RequestInfo
	180, // 6: goautowp.ErrorDetails.help:type_name -> google.rpc.Help
	181, // 7: goautowp.ErrorDetails.localizedMessage:type_name -> google.rpc.LocalizedMessage
	...
	182, // 29: goautowp.APIUser.last_online:type_name -> google.protobuf.Timestamp
	...
	182, // 35: goautowp.APIBanItem.until:type_name -> google.protobuf.Timestamp
	...
	182, // 43: goautowp.APIForumsTopic.created_at:type_name -> google.protobuf.Timestamp
	...
	182, // 46: goautowp.APICommentMessage.created_at:type_name -> google.protobuf.Timestamp
	...
	182, // 74: goautowp.APIMessage.date:type_name -> google.protobuf.Timestamp
	...
	182, // 78: goautowp.VODDataDate.date:type_name -> google.protobuf.Timestamp
	...
	182, // 83: goautowp.Article.date:type_name -> google.protobuf.Timestamp
	...
	4,   // 86: goautowp.AddCommentRequest.type_id:type_name -> goautowp.CommentsType
	164, // 87: goautowp.GetMessageRequest.fields:type_name -> goautowp.CommentMessageFields
	164, // 88: goautowp.GetMessagesRequest.fields:type_name -> goautowp.CommentMessageFields
	4,   // 89: goautowp.GetMessagesRequest.type_id:type_name -> goautowp.CommentsType
	9,   // 90: goautowp.GetMessagesRequest.order:type_name -> goautowp.GetMessagesRequest.Order
	5,   // 91: goautowp.GetMessagesRequest.moderator_attention:type_name -> goautowp.ModeratorAttention
	4,   // 92: goautowp.APICommentsMessagePage.type_id:type_name -> goautowp.CommentsType
	169, // 93: goautowp.APICommentsMessages.items:type_name -> goautowp.APICommentsMessage
	140, // 94: goautowp.APICommentsMessages.paginator:type_name -> goautowp.Pages
	4,   // 95: goautowp.APICommentsMessage.type_id:type_name -> goautowp.CommentsType
	182, // 96: goautowp.APICommentsMessage.created_at:type_name -> google.protobuf.Timestamp
	5,   // 97: goautowp.APICommentsMessage.moderator_attention:type_name -> goautowp.ModeratorAttention
	169, // 98: goautowp.APICommentsMessage.replies:type_name -> goautowp.APICommentsMessage
	2,   // 99: goautowp.APICommentsMessage.picture_status:type_name -> goautowp.PictureStatus
	172, // 100: goautowp.APIGetTextResponse.current:type_name -> goautowp.TextRevision
	172, // 101: goautowp.APIGetTextResponse.prev:type_name -> goautowp.TextRevision
	172, // 102: goautowp.APIGetTextResponse.next:type_name -> goautowp.TextRevision
	40,  // 103: goautowp.Autowp.AclEnforce:input_type -> goautowp.AclEnforceRequest
	63,  // 104: goautowp.Autowp.CreateFeedback:input_type -> goautowp.APICreateFeedbackRequest
	183, // 105: goautowp.Autowp.GetBrandIcons:input_type -> google.protobuf.Empty
	44,  // 106: goautowp.Autowp.GetBrandVehicleTypes:input_type -> goautowp.GetBrandVehicleTypesRequest
	60,  // 107: goautowp.Autowp.GetIP:input_type -> goautowp.APIGetIPRequest
	183, // 108: goautowp.Autowp.GetPerspectives:input_type -> google.protobuf.Empty
	183, // 109: goautowp.Autowp.GetPerspectivePages:input_type -> google.protobuf.Empty
	183, // 110: goautowp.Autowp.GetReCaptchaConfig:input_type -> google.protobuf.Empty
	183, // 111: goautowp.Autowp.GetSpecs:input_type -> google.protobuf.Empty
	183, // 112: goautowp.Autowp.GetVehicleTypes:input_type -> google.protobuf.Empty
	183, // 113: goautowp.Forums.GetUserSummary:input_type -> google.protobuf.Empty
	80,  // 114: goautowp.Forums.CreateTopic:input_type -> goautowp.APICreateTopicRequest
	82,  // 115: goautowp.Forums.CloseTopic:input_type -> goautowp.APISetTopicStatusRequest
	82,  // 116: goautowp.Forums.OpenTopic:input_type -> goautowp.APISetTopicStatusRequest
	82,  // 117: goautowp.Forums.DeleteTopic:input_type -> goautowp.APISetTopicStatusRequest
	83,  // 118: goautowp.Forums.MoveTopic:input_type -> goautowp.APIMoveTopicRequest
	71,  // 119: goautowp.Forums.GetTheme:input_type -> goautowp.APIGetForumsThemeRequest
	74,  // 120: goautowp.Forums.GetThemes:input_type -> goautowp.APIGetForumsThemesRequest
	73,  // 121: goautowp.Forums.GetTopic:input_type -> goautowp.APIGetForumsTopicRequest
	71,  // 122: goautowp.Forums.GetLastTopic:input_type -> goautowp.APIGetForumsThemeRequest
	73,  // 123: goautowp.Forums.GetLastMessage:input_type -> goautowp.APIGetForumsTopicRequest
	72,  // 124: goautowp.Forums.GetTopics:input_type -> goautowp.APIGetForumsTopicsRequest
	148, // 125: goautowp.Articles.GetList:input_type -> goautowp.ArticlesRequest
	151, // 126: goautowp.Articles.GetItemByCatname:input_type -> goautowp.ArticleByCatnameRequest
	66,  // 127: goautowp.Traffic.AddToBlacklist:input_type -> goautowp.AddToTrafficBlacklistRequest
	67,  // 128: goautowp.Traffic.AddToWhitelist:input_type -> goautowp.AddToTrafficWhitelistRequest
	65,  // 129: goautowp.Traffic.DeleteFromBlacklist:input_type -> goautowp.DeleteFromTrafficBlacklistRequest
	64,  // 130: goautowp.Traffic.DeleteFromWhitelist:input_type -> goautowp.DeleteFromTrafficWhitelistRequest
	183, // 131: goautowp.Traffic.GetTop:input_type -> google.protobuf.Empty
	183, // 132: goautowp.Traffic.GetWhitelist:input_type -> google.protobuf.Empty
	47,  // 133: goautowp.Contacts.CreateContact:input_type -> goautowp.CreateContactRequest
	48,  // 134: goautowp.Contacts.DeleteContact:input_type -> goautowp.DeleteContactRequest
	49,  // 135: goautowp.Contacts.GetContact:input_type -> goautowp.GetContactRequest
	54,  // 136: goautowp.Contacts.GetContacts:input_type -> goautowp.GetContactsRequest
	86,  // 137: goautowp.Users.DeleteUser:input_type -> goautowp.APIDeleteUserRequest
	88,  // 138: goautowp.Users.GetUser:input_type -> goautowp.APIGetUserRequest
	87,  // 139: goautowp.Users.Me:input_type -> goautowp.APIMeRequest
	144, // 140: goautowp.Users.GetUserPreferences:input_type -> goautowp.APIUserPreferencesRequest
	144, // 141: goautowp.Users.DisableUserCommentsNotifications:input_type -> goautowp.APIUserPreferencesRequest
	144, // 142: goautowp.Users.EnableUserCommentsNotifications:input_type -> goautowp.APIUserPreferencesRequest
	146, // 143: goautowp.Users.GetUsers:input_type -> goautowp.APIUsersRequest
	89,  // 144: goautowp.Items.GetTopBrandsList:input_type -> goautowp.GetTopBrandsListRequest
	92,  // 145: goautowp.Items.GetTopPersonsList:input_type -> goautowp.GetTopPersonsListRequest
	96,  // 146: goautowp.Items.GetTopFactoriesList:input_type -> goautowp.GetTopFactoriesListRequest
	95,  // 147: goautowp.Items.GetTopCategoriesList:input_type -> goautowp.GetTopCategoriesListRequest
	93,  // 148: goautowp.Items.GetTwinsBrandsList:input_type -> goautowp.GetTwinsBrandsListRequest
	94,  // 149: goautowp.Items.GetTopTwinsBrandsList:input_type -> goautowp.GetTopTwinsBrandsListRequest
	111, // 150: goautowp.Items.List:input_type -> goautowp.ListItemsRequest
	112, // 151: goautowp.Items.GetTree:input_type -> goautowp.GetTreeRequest
	183, // 152: goautowp.Items.GetContentLanguages:input_type -> google.protobuf.Empty
	153, // 153: goautowp.Items.GetItemLink:input_type -> goautowp.APIItemLinkRequest
	154, // 154: goautowp.Items.GetItemLinks:input_type -> goautowp.APIGetItemLinksRequest
	153, // 155: goautowp.Items.DeleteItemLink:input_type -> goautowp.APIItemLinkRequest
	156, // 156: goautowp.Items.CreateItemLink:input_type -> goautowp.APIItemLink
	156, // 157: goautowp.Items.UpdateItemLink:input_type -> goautowp.APIItemLink
	158, // 158: goautowp.Items.GetItemVehicleTypes:input_type -> goautowp.APIGetItemVehicleTypesRequest
	161, // 159: goautowp.Items.GetItemVehicleType:input_type -> goautowp.APIItemVehicleTypeRequest
	159, // 160: goautowp.Items.CreateItemVehicleType:input_type -> goautowp.APIItemVehicleType
	161, // 161: goautowp.Items.DeleteItemVehicleType:input_type -> goautowp.APIItemVehicleTypeRequest
	118, // 162: goautowp.Comments.GetCommentVotes:input_type -> goautowp.GetCommentVotesRequest
	116, // 163: goautowp.Comments.Subscribe:input_type -> goautowp.CommentsSubscribeRequest
	117, // 164: goautowp.Comments.UnSubscribe:input_type -> goautowp.CommentsUnSubscribeRequest
	119, // 165: goautowp.Comments.View:input_type -> goautowp.CommentsViewRequest
	120, // 166: goautowp.Comments.SetDeleted:input_type -> goautowp.CommentsSetDeletedRequest
	121, // 167: goautowp.Comments.MoveComment:input_type -> goautowp.CommentsMoveCommentRequest
	122, // 168: goautowp.Comments.VoteComment:input_type -> goautowp.CommentsVoteCommentRequest
	162, // 169: goautowp.Comments.Add:input_type -> goautowp.AddCommentRequest
	163, // 170: goautowp.Comments.GetMessagePage:input_type -> goautowp.GetMessagePageRequest
	165, // 171: goautowp.Comments.GetMessage:input_type -> goautowp.GetMessageRequest
	166, // 172: goautowp.Comments.GetMessages:input_type -> goautowp.GetMessagesRequest
	124, // 173: goautowp.Map.GetPoints:input_type -> goautowp.MapGetPointsRequest
	128, // 174: goautowp.Pictures.View:input_type -> goautowp.PicturesViewRequest
	129, // 175: goautowp.Pictures.Vote:input_type -> goautowp.PicturesVoteRequest
	131, // 176: goautowp.Pictures.CreateModerVoteTemplate:input_type -> goautowp.ModerVoteTemplate
	133, // 177: goautowp.Pictures.DeleteModerVoteTemplate:input_type -> goautowp.DeleteModerVoteTemplateRequest
	183, // 178: goautowp.Pictures.GetModerVoteTemplates:input_type -> google.protobuf.Empty
	183, // 179: goautowp.Messaging.GetMessagesNewCount:input_type -> google.protobuf.Empty
	183, // 180: goautowp.Messaging.GetMessagesSummary:input_type -> google.protobuf.Empty
	134, // 181: goautowp.Messaging.DeleteMessage:input_type -> goautowp.MessagingDeleteMessage
	135, // 182: goautowp.Messaging.ClearFolder:input_type -> goautowp.MessagingClearFolder
	136, // 183: goautowp.Messaging.CreateMessage:input_type -> goautowp.MessagingCreateMessage
	138, // 184: goautowp.Messaging.GetMessages:input_type -> goautowp.MessagingGetMessagesRequest
	27,  // 185: goautowp.Statistics.GetPulse:input_type -> goautowp.PulseRequest
	183, // 186: goautowp.Statistics.GetAboutData:input_type -> google.protobuf.Empty
	183, // 187: goautowp.Donations.GetVODData:input_type -> google.protobuf.Empty
	171, // 188: goautowp.Text.GetText:input_type -> goautowp.APIGetTextRequest
	11,  // 189: goautowp.Attrs.GetAttribute:input_type -> goautowp.AttrAttributeID
	12,  // 190: goautowp.Attrs.GetAttributes:input_type -> goautowp.AttrAttributesRequest
	183, // 191: goautowp.Attrs.GetAttributeTypes:input_type -> google.protobuf.Empty
	15,  // 192: goautowp.Attrs.GetListOptions:input_type -> goautowp.AttrListOptionsRequest
	183, // 193: goautowp.Attrs.GetUnits:input_type -> google.protobuf.Empty
	18,  // 194: goautowp.Attrs.GetZoneAttributes:input_type -> goautowp.AttrZoneAttributesRequest
	183, // 195: goautowp.Attrs.GetZones:input_type -> google.protobuf.Empty
	41,  // 196: goautowp.Autowp.AclEnforce:output_type -> goautowp.AclEnforceResult
	183, // 197: goautowp.Autowp.CreateFeedback:output_type -> google.protobuf.Empty
	39,  // 198: goautowp.Autowp.GetBrandIcons:output_type -> goautowp.BrandIcons
	45,  // 199: goautowp.Autowp.GetBrandVehicleTypes:output_type -> goautowp.BrandVehicleTypeItems
	62,  // 200: goautowp.Autowp.GetIP:output_type -> goautowp.APIIP
	34,  // 201: goautowp.Autowp.GetPerspectives:output_type -> goautowp.PerspectivesItems
	37,  // 202: goautowp.Autowp.GetPerspectivePages:output_type -> goautowp.PerspectivePagesItems
	38,  // 203: goautowp.Autowp.GetReCaptchaConfig:output_type -> goautowp.ReCaptchaConfig
	32,  // 204: goautowp.Autowp.GetSpecs:output_type -> goautowp.SpecsItems
	43,  // 205: goautowp.Autowp.GetVehicleTypes:output_type -> goautowp.VehicleTypeItems
	70,  // 206: goautowp.Forums.GetUserSummary:output_type -> goautowp.APIForumsUserSummary
	81,  // 207: goautowp.Forums.CreateTopic:output_type -> goautowp.APICreateTopicResponse
	183, // 208: goautowp.Forums.CloseTopic:output_type -> google.protobuf.Empty
	183, // 209: goautowp.Forums.OpenTopic:output_type -> google.protobuf.Empty
	183, // 210: goautowp.Forums.DeleteTopic:output_type -> google.protobuf.Empty
	183, // 211: goautowp.Forums.MoveTopic:output_type -> google.protobuf.Empty
	75,  // 212: goautowp.Forums.GetTheme:output_type -> goautowp.APIForumsTheme
	76,  // 213: goautowp.Forums.GetThemes:output_type -> goautowp.APIForumsThemes
	77,  // 214: goautowp.Forums.GetTopic:output_type -> goautowp.APIForumsTopic
	77,  // 215: goautowp.Forums.GetLastTopic:output_type -> goautowp.APIForumsTopic
	79,  // 216: goautowp.Forums.GetLastMessage:output_type -> goautowp.APICommentMessage
	78,  // 217: goautowp.Forums.GetTopics:output_type -> goautowp.APIForumsTopics
	149, // 218: goautowp.Articles.GetList:output_type -> goautowp.ArticlesResponse
	150, // 219: goautowp.Articles.GetItemByCatname:output_type -> goautowp.Article
	183, // 220: goautowp.Traffic.AddToBlacklist:output_type -> google.protobuf.Empty
	183, // 221: goautowp.Traffic.AddToWhitelist:output_type -> google.protobuf.Empty
	183, // 222: goautowp.Traffic.DeleteFromBlacklist:output_type -> google.protobuf.Empty
	183, // 223: goautowp.Traffic.DeleteFromWhitelist:output_type -> google.protobuf.Empty
	59,  // 224: goautowp.Traffic.GetTop:output_type -> goautowp.APITrafficTopResponse
	69,  // 225: goautowp.Traffic.GetWhitelist:output_type -> goautowp.APITrafficWhitelistItems
	183, // 226: goautowp.Contacts.CreateContact:output_type -> google.protobuf.Empty
	183, // 227: goautowp.Contacts.DeleteContact:output_type -> google.protobuf.Empty
	52,  // 228: goautowp.Contacts.GetContact:output_type -> goautowp.Contact
	53,  // 229: goautowp.Contacts.GetContacts:output_type -> goautowp.ContactItems
	183, // 230: goautowp.Users.DeleteUser:output_type -> google.protobuf.Empty
	51,  // 231: goautowp.Users.GetUser:output_type -> goautowp.APIUser
	51,  // 232: goautowp.Users.Me:output_type -> goautowp.APIUser
	145, // 233: goautowp.Users.GetUserPreferences:output_type -> goautowp.APIUserPreferencesResponse
	183, // 234: goautowp.Users.DisableUserCommentsNotifications:output_type -> google.protobuf.Empty
	183, // 235: goautowp.Users.EnableUserCommentsNotifications:output_type -> google.protobuf.Empty
	147, // 236: goautowp.Users.GetUsers:output_type -> goautowp.APIUsersResponse
	90,  // 237: goautowp.Items.GetTopBrandsList:output_type -> goautowp.APITopBrandsList
	97,  // 238: goautowp.Items.GetTopPersonsList:output_type -> goautowp.APITopPersonsList
	104, // 239: goautowp.Items.GetTopFactoriesList:output_type -> goautowp.APITopFactoriesList
	102, // 240: goautowp.Items.GetTopCategoriesList:output_type -> goautowp.APITopCategoriesList
	100, // 241: goautowp.Items.GetTwinsBrandsList:output_type -> goautowp.APITwinsBrandsList
	101, // 242: goautowp.Items.GetTopTwinsBrandsList:output_type -> goautowp.APITopTwinsBrandsList
	115, // 243: goautowp.Items.List:output_type -> goautowp.APIItemList
	113, // 244: goautowp.Items.GetTree:output_type -> goautowp.APITreeItem
	152, // 245: goautowp.Items.GetContentLanguages:output_type -> goautowp.APIContentLanguages
	156, // 246: goautowp.Items.GetItemLink:output_type -> goautowp.APIItemLink
	155, // 247: goautowp.Items.GetItemLinks:output_type -> goautowp.APIItemLinksResponse
	183, // 248: goautowp.Items.DeleteItemLink:output_type -> google.protobuf.Empty
	157, // 249: goautowp.Items.CreateItemLink:output_type -> goautowp.APICreateItemLinkResponse
	183, // 250: goautowp.Items.UpdateItemLink:output_type -> google.protobuf.Empty
	160, // 251: goautowp.Items.GetItemVehicleTypes:output_type -> goautowp.APIGetItemVehicleTypesResponse
	159, // 252: goautowp.Items.GetItemVehicleType:output_type -> goautowp.APIItemVehicleType
	183, // 253: goautowp.Items.CreateItemVehicleType:output_type -> google.protobuf.Empty
	183, // 254: goautowp.Items.DeleteItemVehicleType:output_type -> google.protobuf.Empty
	55,  // 255: goautowp.Comments.GetCommentVotes:output_type -> goautowp.CommentVoteItems
	183, // 256: goautowp.Comments.Subscribe:output_type -> google.protobuf.Empty
	183, // 257: goautowp.Comments.UnSubscribe:output_type -> google.protobuf.Empty
	183, // 258: goautowp.Comments.View:output_type -> google.protobuf.Empty
	183, // 259: goautowp.Comments.SetDeleted:output_type -> google.protobuf.Empty
	183, // 260: goautowp.Comments.MoveComment:output_type -> google.protobuf.Empty
	123, // 261: goautowp.Comments.VoteComment:output_type -> goautowp.CommentsVoteCommentResponse
	170, // 262: goautowp.Comments.Add:output_type -> goautowp.AddCommentResponse
	167, // 263: goautowp.Comments.GetMessagePage:output_type -> goautowp.APICommentsMessagePage
	169, // 264: goautowp.Comments.GetMessage:output_type -> goautowp.APICommentsMessage
	168, // 265: goautowp.Comments.GetMessages:output_type -> goautowp.APICommentsMessages
	126, // 266: goautowp.Map.GetPoints:output_type -> goautowp.MapPoints
	183, // 267: goautowp.Pictures.View:output_type -> google.protobuf.Empty
	130, // 268: goautowp.Pictures.Vote:output_type -> goautowp.PicturesVoteSummary
	131, // 269: goautowp.Pictures.CreateModerVoteTemplate:output_type -> goautowp.ModerVoteTemplate
	183, // 270: goautowp.Pictures.DeleteModerVoteTemplate:output_type -> google.protobuf.Empty
	132, // 271: goautowp.Pictures.GetModerVoteTemplates:output_type -> goautowp.ModerVoteTemplates
	84,  // 272: goautowp.Messaging.GetMessagesNewCount:output_type -> goautowp.APIMessageNewCount
	85,  // 273: goautowp.Messaging.GetMessagesSummary:output_type -> goautowp.APIMessageSummary
	183, // 274: goautowp.Messaging.DeleteMessage:output_type -> google.protobuf.Empty
	183, // 275: goautowp.Messaging.ClearFolder:output_type -> google.protobuf.Empty
	183, // 276: goautowp.Messaging.CreateMessage:output_type -> google.protobuf.Empty
	139, // 277: goautowp.Messaging.GetMessages:output_type -> goautowp.MessagingGetMessagesResponse
	30,  // 278: goautowp.Statistics.GetPulse:output_type -> goautowp.PulseResponse
	143, // 279: goautowp.Statistics.GetAboutData:output_type -> goautowp.AboutDataResponse
	141, // 280: goautowp.Donations.GetVODData:output_type -> goautowp.VODDataResponse
	173, // 281: goautowp.Text.GetText:output_type -> goautowp.APIGetTextResponse
	14,  // 282: goautowp.Attrs.GetAttribute:output_type -> goautowp.AttrAttribute
	13,  // 283: goautowp.Attrs.GetAttributes:output_type -> goautowp.AttrAttributesResponse
	21,  // 284: goautowp.Attrs.GetAttributeTypes:output_type -> goautowp.AttrAttributeTypesResponse
	16,  // 285: goautowp.Attrs.GetListOptions:output_type -> goautowp.AttrListOptionsResponse
	23,  // 286: goautowp.Attrs.GetUnits:output_type -> goautowp.AttrUnitsResponse
	19,  // 287: goautowp.Attrs.GetZoneAttributes:output_type -> goautowp.AttrZoneAttributesResponse
	25,  // 288: goautowp.Attrs.GetZones:output_type -> goautowp.AttrZonesResponse
