...
const (
	...
	AttrsUserValuesListTableUserIDColName      = "user_id"
	AttrsUserValuesListTableAttributeIDColName = "attribute_id"
	AttrsUserValuesListTableItemIDColName      = "item_id"
	AttrsUserValuesListTableValueColName       = "value"
